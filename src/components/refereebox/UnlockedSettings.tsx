...
interface SettingsPanelProps {
    ...
    onEndGame?: () => void;   // ← ADDED: called when referee confirms END GAME
}
...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
    ...
    sendAction, onEndGame,    // ← ADDED onEndGame
}) => {
    ...
    return (
        <div style={{
            ...
            border: '3px solid #F97316', borderRadius: '4px',
        }}>
            {/* ── WARNING HEADER ── */}
            <div style={{
                height: '40px',
                ...
                <span style={{
                    ...
                    fontSize: '16px', letterSpacing: '0.2em', color: '#F97316',
                }}>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px' }}>
                    <div style={{
                        fontFamily: "'Oswald', sans-serif", fontWeight: 700,
                        fontSize: '18px', letterSpacing: '0.1em', color: teamAColor,
                    }}>
                        {teamA.name}
                    </div>
                    <StatRow
                        ...
                        color={teamAColor} valueFontSize="36px"
                    />
                    <StatRow
                ...
                <div style={{
                    ...
                    <StatRow
                        ...
                        color="#22C55E" valueColor="#22C55E" valueFontSize="24px"
                    />
                    <StatRow
                        ...
                        color="#F59E0B" valueColor="#F59E0B" valueFontSize="24px"
                    />
                    <StatRow
                        label="PERIOD" value={clock.period}
                    ...
                    {!showEndConfirm ? (
                        <div
                            ...
                            style={{
                                ...
                                background: '#1a0808', border: '1.5px solid #3a1a1a',
                        ...
                        <div style={{ display: 'flex', gap: '8px', width: '100%' }}>
                            <div
                                ...
                                style={{
                                    flex: 1, height: '44px', background: '#111',
                            ...
                            <div
                                onClick={() => {
                                    // ← CHANGED: call onEndGame if provided, else fallback
                                    if (onEndGame) {
                                        onEndGame();
                                    } else {
                                        sendAction('END_GAME');
                                ...
                                style={{
                                    flex: 1, height: '44px', background: '#EF4444',
                                    borderRadius: '8px', display: 'flex',
                                    alignItems: 'center', justifyContent: 'center',
                                    fontFamily: "'Barlow', sans-serif", fontSize: '12px',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px' }}>
                    <div style={{
                        fontFamily: "'Oswald', sans-serif", fontWeight: 700,
                        fontSize: '18px', letterSpacing: '0.1em', color: teamBColor,
                    }}>
                        {teamB.name}
                    </div>
                    <StatRow
                        ...
                        color={teamBColor} valueFontSize="36px"
                    />
                    <StatRow
