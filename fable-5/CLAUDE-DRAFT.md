...
> DRAFT written by Fable 5 on 2026-07-07 — reviewed-and-promote candidate for the repo-root
> `CLAUDE.md`. Deliberately lean (~170 lines): universal facts + commands + pointers. Deep
> material lives in the referenced docs and loads only when relevant.
...
- `COMPANION-APP.md` — companion-app ecosystem: wire contracts, LAN Direct protocol, QR/deep-
  link URL space.
- `readme-files/STATS_V2_GAME_ANALYTICS.md` — the stats v2 spec (current stats work follows
  this, not the v1 plan).
